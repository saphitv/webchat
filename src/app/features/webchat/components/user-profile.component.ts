  ...
  template: `
    <div
      ...
      <div
        ...
        *ngIf="this.loading$ | async; else userProfile"
      >
        <div role="status">
          <svg
            aria-hidden="true"
      ...
      <ng-template #userProfile>
        <ng-container *ngIf="user$ | async as user">
          <div class="flex justify-center items-center">
            <div class="card w-1/2 min-w-[400px] h-fit shadow-lg rounded overflow-hidden">

              <div class="flex flex-col items-center justify-center">
                <div class="">
                  <img class="" src="https://source.unsplash.com/random/?city,night">
                  <div class="p-6 flex">
